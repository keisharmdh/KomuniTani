...
public class ChatBotRVAdapter extends RecyclerView.Adapter {
    ...
    public ChatBotRVAdapter(ArrayList<ChatModel> chatModelArrayList, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                view = LayoutInflater.from(context).inflate(R.layout.user_layout_in_chatbot, parent, false);
                return new UserViewHolder(view);

            case 1:
                view = LayoutInflater.from(context).inflate(R.layout.bot_layout_in_chatbot, parent, false);
